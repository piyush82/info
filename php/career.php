	...
	background:#ffffff;text-align:left;width:780px;" id="content">
		...
		<tr>
			...
			<td id="link7" onMouseOver="javascript:changeColor('link7', '#E3E4FA');"
                                onMouseOut="javascript:changeColor('link7','#E3E4FA');"
                                        style="background:#E3E4FA;text-align:center;font-family:Verdana;font-size:10pt;font-weight:bold;width:180px;;">
                                        <a href="javascript:void(0);" style="text-decoration:none;">Career Development</a>
		</table>
		</div>
		...
		<td style="text-align:right;width:420px;font-family:'ArialMT', 'Arial', sans-serif;font-size:36px;color:#333366;font-weight:normal;">professional development
		</table>
		</div>
		...
		<tr>
			<td style="background:white;width:470px;" valign="top">
				<table style="background:white;width:489px;border:0px;position:relative;top:-2px;margin:0px;" cellpadding="0px">
					<tr><td>
                                		<div style="margin-top:1px;position:relative;width:245px;z-index:0;height:310px;background:#98AFC7;">
                                        	<image src="image/page5img1.jpg" style="width:225px;height:290px;margin-left:10px;margin-top:10px;">
                                		</div>
					<td>
						<div style="margin-top:1px;position:relative;width:244px;z-index:0;height:310px;background:#98AFC7;">
                                                <image src="image/page5img2.jpg" style="width:225px;height:290px;margin-left:10px;margin-top:10px;">
                                        	</div>
				</table>
					...
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                        <span class="style_4"><b>COP5615 - Distributed Systems</b> - Fall 06, 07, 09; Spring 08; Summer 08</span>
                                        </div>
                                        <div style="margin-top:0px;margin-left:5px;margin-bottom:10px;color:#2B3856;" class="paragraph_style_4">
                                                <table style="border:0px;background:#FFFFFF;">
                                                <tr>
                                                        <td>
                                                                <ul class="paragraph_style_4">
								<li>Assisted in development of class projects and assignments.
								<li>Helped in grading, answered student questions.
                                                                </ul>
                                                </table>   
                                        </div>
					
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                        <span class="style_4"><b>CNT5410 - Computer & Network Security</b> - Fall 05, 08; Spring 06</span>
                                        </div>
                                        <div style="margin-top:0px;margin-left:5px;margin-bottom:10px;color:#2B3856;" class="paragraph_style_4">
                                                <table style="border:0px;background:#FFFFFF;">
                                                <tr>
                                                        <td>                                                    
                                                                ...
                                                                <li>Assisted in development of class projects and assignments.       
                                                                <li>Helped in grading, answered student questions.
								<li>Setup and maintenance of UF-IBA course management platform.                        
                                                                </ul>                                                                                             
                                                </table>        
                                        </div>

					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                        <span class="style_4"><b>CEN5501C - Computer Networks</b> - Spring 07; Summer 07</span>
                                        </div>
                                        <div style="margin-top:0px;margin-left:5px;margin-bottom:10px;color:#2B3856;" class="paragraph_style_4">
                                                <table style="border:0px;background:#FFFFFF;">
                                                <tr>
					...
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                        <span class="style_4"><b>COT3100 - Discreet Structures</b> - Fall 04; Spring 05; Summer 07</span>            
                                        </div>
                                        <div style="margin-top:0px;margin-left:5px;margin-bottom:10px;color:#2B3856;" class="paragraph_style_4">
                                                <table style="border:0px;background:#FFFFFF;">
                                                <tr>
                                                        <td>
                                                                <ul class="paragraph_style_4">
                                                                <li>Developed discussion session materials and presented them in class.
                                                                <li>Helped in grading, answered student questions.
                                                                </ul>                                                          
                                                </table>
                                        </div>
					...
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                        <span class="style_4"><b>CDA3101 - Computer Organization</b> - Summer 04</span>
                                        </div>
                                        <div style="margin-top:0px;margin-left:5px;margin-bottom:10px;color:#2B3856;" class="paragraph_style_4">
                                                <table style="border:0px;background:#FFFFFF;">
                                                <tr>
					...
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                        <span class="style_4"><b>CGS2531 - Problem Solving Using Softwares</b> - Fall 03; Spring 04</span>                    
                                        </div>
			...
			<td style="background:white;width:230px;" valign="top">
				<div style="margin:1px;position:relative;width:210px;z-index:0;height:236px;background:#98AFC7;">
					<image src="image/page5img3.jpg" style="width:190px;height:216px;margin-left:10px;margin-top:10px;">
				</div>
				<div style="margin:1px;position:relative;width:210px;z-index:0;height:73px;background:#98AFC7;">
					<div style="padding:8px;font-family:'ArialMT', 'Arial', sans-serif;font-size:8pt;text-align:left;font-weight:normal;color:navy;">
						Photographs: Left-right - Baldwin beach in Jacksonville FL, sunset at Cedar Keys FL, bike underpass in Innsbruck - Austria.
					</div>
                                </div>
				...
				<div style="margin:1px;position:relative;width:210px;z-index:0;height:40px;background:#FFFFFF;">
					<div style="padding:10px;font-family:'ArialMT', 'Arial', sans-serif;font-size:12pt;text-align:left;font-weight:normal;color:navy;">
                                                <a href="javascript:void(0);" style="text-decoration:none;">Professional Development</a>
                                        </div>
                                </div>
                                <div style="margin:1px;position:relative;width:210px;z-index:0;height:40px;background:#98AFC7;">
					<div style="padding:10px;font-family:'ArialMT', 'Arial', sans-serif;font-size:13pt;text-align:left;font-weight:normal;color:navy;">
...
<script type="text/javascript">
var sc_project=5066491; 
var sc_invisible=1; 
var sc_partition=58; 
var sc_click_stat=1; 
var sc_security="74aea42c"; 
</script>
...
src="http://c.statcounter.com/5066491/0/74aea42c/1/"
alt="wordpress stat" ></a></div></noscript>
<!-- End of StatCounter Code -->

<div style="position:absolute;top:450px;left:5%;width:90%;height:250px;background:black;color:white;opacity:0.5;filter:alpha(opacity=50);text-align:center;font-family:Verdana;font-size:50px;">
