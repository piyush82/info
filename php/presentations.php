	...
	background:#ffffff;text-align:left;width:780px;" id="content">
		...
		<tr>
			...
			<td id="link4" onMouseOver="javascript:changeColor('link4', '#E3E4FA');"
                                onMouseOut="javascript:changeColor('link4','#E3E4FA');"
                                        style="background:#E3E4FA;text-align:center;font-family:Verdana;font-size:10pt;font-weight:bold;width:110px;">
                                        <a href="javascript:void(0);" style="text-decoration:none;">Presentations</a>
		...
		<td style="text-align:right;width:420px;font-family:'ArialMT', 'Arial', sans-serif;font-size:36px;color:#333366;font-weight:normal;">presentations
		</table>
		</div>
		...
		<tr>
			<td style="background:white;width:470px;" valign="top">
					...
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                                <table style="border:0px;"><tr><td class="paragraph_style_2">
                                                        <span><b>Mode Independent Session Directory Service Architecture</b>, presented at 
								<i>The 2010 Symposium on Applied Computing</i>, organized by ACM SIGAPP.</span>
                                                        <td style="width:33px;" valign="top">
                                                        <a
href="content/ACM_SAC_2010_NETS.pdf" target="_blank">
                                                        <image src="image/pdf-small.gif"></a>
                                                </table>
                                        </div>
					
                                        <div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                                <table style="border:0px;"><tr><td class="paragraph_style_2">
                                                        <span><b>Gray Networking</b>, presented at 
                                                                <i>The 2010 Symposium on Applied Computing</i>, organized by ACM SIGAPP.</span>
                                                        <td style="width:33px;" valign="top">
                                                        <a
href="content/ACM_SAC_2010_SCS.pdf" target="_blank">      
                                                        <image src="image/pdf-small.gif"></a>
                                                </table>
                                        </div>       
					...
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
						<table style="border:0px;"><tr><td class="paragraph_style_2">
                                        		<span><b>Distributed Search for Multicast Sessions</b>, presented at <i>The 2009 International Conference on Internet 
								Computing</i></span>
							<td style="width:33px;" valign="top">
							<a
href="content/ICOMP_2009_Presentation.pdf" target="_blank">
							<image src="image/pdf-small.gif"></a>
						</table>
                                        </div>					
					...
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                                <table style="border:0px;"><tr><td class="paragraph_style_2">
                                                        <span><b>Using Geo-Spatial Session Tagging for Smart Multicast Session Discovery</b>, presented at 
								<i>The 2009 Symposium on Applied Computing</i>,
							organized by ACM SIGAPP.</span>
                                                        <td style="width:33px;" valign="top">
                                                        <a
href="content/ACM_SAC_2009_Presentation.pdf" target="_blank">
                                                        <image src="image/pdf-small.gif"></a>
                                                </table>
                                        </div>
					...
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                                <table style="border:0px;"><tr><td class="paragraph_style_2">
                                                        <span><b>Proposal for Hierarchical Multicast Session Directory Architecture</b>, presented at <i>The 2008 International Conference on Internet Computing</i></span>
                                                        <td style="width:33px;" valign="top">
                                                        <a
href="content/ICOMP_2008_Presentation.pdf" target="_blank">
                                                        <image src="image/pdf-small.gif"></a>
                                                </table>
                                        </div>
					...
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                                <table style="border:0px;"><tr><td class="paragraph_style_2">
                                                        <span><b>An Overlay Solution to IP-Multicast Address Collision Prevention</b>, presented at <i>The Fourth IASTED European Conference on Internet and Multimedia
								Systems and Applications</i></span>
                                                        <td style="width:33px;" valign="top">
                                                        <a
href="content/EuroIMSA_2008_Presentation.pdf" target="_blank">
                                                        <image src="image/pdf-small.gif"></a>
                                                </table>
                                        </div>
					...
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                                <table style="border:0px;"><tr><td class="paragraph_style_2">
                                                        <span><b>Multicast Address Allocation</b>, <i>CONS Research Group Seminar</i>, presented on October 10 2007</span>
                                                        <td style="width:33px;" valign="top">
                                                        <a
href="content/Oct_10_2007_CONS_Multicast_Address_Allocation.pdf"
target="_blank">
                                                        <image src="image/pdf-small.gif"></a>
                                                </table>
                                        </div>
					...
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                                <table style="border:0px;"><tr><td class="paragraph_style_2">
                                                        <span><b>Multicast Routing Algorithm</b>, <i>CONS Research Group Seminar</i>, presented on May 30 2007</span>
                                                     	 <td style="width:33px;" valign="top">      
                                                        <a
href="content/May_30_2007_CONS_Multicast_Routing_Algorithm.pdf" target="_blank">
                                                        <image src="image/pdf-small.gif"></a>
                                                </table>
                                        </div>
					...
					<div style="margin-top:0px;margin-left:5px;margin-bottom:5px;color:#2B3856;" class="paragraph_style_2">
                                                <table style="border:0px;"><tr><td class="paragraph_style_2">
                                                        <span><b>Multicast Addresses</b>, <i>CONS Research Group Seminar</i>, presented on April 11 2007</span>
                                                        <td style="width:33px;" valign="top">
                                                        <a
href="content/Apr_11_2007_CONS_Multicast_Addresses.pdf" target="_blank"> 
                                                        <image src="image/pdf-small.gif"></a>
                                                </table>
                                        </div>
