...
//{   
//        $sec = 0;
//        header("Refresh: $sec; url=" . $redirect . "getuname.php");
//        exit(0); 
//}
?>
<?php
...
<p class="front">Welcome registered IBA-survey user!</p>
<form class="register" method="post" action="getuname1.php">
Enter Your Firstname: <input class="register" type="text" name="firstname" size="27">
<br>
Enter Your Lastname: <input class="register" type="text" name="lastname" size="27">
<br>
Enter last 4 digits of UFID: <input class="register" type="password" name="ufid" size="4" maxlength="4"> 
Gender:
